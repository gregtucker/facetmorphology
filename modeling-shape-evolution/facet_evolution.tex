...
\caption{Conceptual illustration showing how fault slip rate, $V$, fault dip angle, $\alpha$, and slope-normal erosion rate, $E_n$, combine to set the dip angle of a facet profile. (Modified from \citet{tucker2011geomorphic}.)} 
...
- UPDATE FACET SCHEMATIC TO USE SIN AND SLOPE-NORMAL

- UPDATE CALCS AND FIGURES OF DISS-LIM 

- UPDATE PLOT OF W-D WITH CORRECT DISS-LIM CURVE
