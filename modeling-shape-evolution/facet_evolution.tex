...
[NEXT STEPS: RUN A FULL SUITE OF LONG RUNS IN D-W SPACE TO GAUGE LENGTH EFFECT (PROBABLY PLAYS A ROLE FOR T-LIM BELOW ANGREP, AND PERHAPS ONSET OF ANGREP.]

...note that angle of repose is kind of an attractor state: any solution with $w'\gg d'$ and $d'\ge 1$ gives you ang rep.
