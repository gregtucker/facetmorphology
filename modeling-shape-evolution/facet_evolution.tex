...
\label{eq:dissangle}
\end{equation}
where $\theta$ and $\alpha$ are both in radians. 

[ADD PREDICTED DIP ANGLES TO THE 4 DISSOLUTION PLOTS]


[start with section to demonstrate that tests ability of model in purely weathering-limited configuration to reproduce geometric model of Tucker 2011; add to the figure a couple of runs demonstrating change in width]
